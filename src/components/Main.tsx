  ...
  return (
    <div className='max-w-6xl mx-auto rounded-3xl flex flex-col md:flex-row justify-between items-center mt-32 gap-16 md:gap-0 md:px-5'>
      <div className=' flex flex-col justify-normal items-left gap-2 max-w-[500px]'>
        ...
        <div className='flex gap-5 mt-16 px-5 items-start wrapper'>
          <textarea placeholder='Please enter text' value={input} onChange={handleInputChange} className='text-black !outline-none text-base w-[150%] font-semibold border-2 border-grey-300 p-2 rounded-md min-h-[100px]' />
